...
class TestBranchValidation(unittest.TestCase):
    ...
    def test_valid_branch_names(self):
        ...
        for branch in valid_branches:
            self.assertTrue(self.scanner._validate_branch_name(branch), f"Should accept valid branch: {branch}")
    ...
    def test_invalid_branch_names(self):
        ...
        for branch in invalid_branches:
            self.assertFalse(self.scanner._validate_branch_name(branch), f"Should reject invalid branch: {branch}")
